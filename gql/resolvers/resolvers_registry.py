...
from gql.resolvers.query.users import get_users_mavim_manager
...
from gql.resolvers.query.manager_user_login_details import get_manager_user_login_details
